...
SET_TYPES = (
    ...
    (SET_TYPE.OFFROADFLATS.name, SET_TYPE.OFFROADFLATS.value, SET_TYPE.OFFROADFLATS.name),
    (SET_TYPE.OFFROADBANKS.name, SET_TYPE.OFFROADBANKS.value, SET_TYPE.OFFROADBANKS.name),
    (SET_TYPE.OFFROADTRANSITIONS.name, SET_TYPE.OFFROADTRANSITIONS.value, SET_TYPE.OFFROADTRANSITIONS.name),
